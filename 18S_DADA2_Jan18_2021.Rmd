...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, truncLen=c(227,150),
...
Assign taxonomy:
```{r}
taxa <- assignTaxonomy(seqtab.nochim, "/Users/swellan.pinto/Desktop/18S_Jan13_2021_SLP/trimmed_unzipped_edited/pr2_version_4.12.0_18S_dada2.fasta.gz", multithread=TRUE)
