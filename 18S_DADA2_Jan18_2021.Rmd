...
Assign taxonomy:
```{r}
taxa <- assignTaxonomy(seqtab.nochim, "/Users/swellan.pinto/Desktop/18S_Jan13_2021_SLP/trimmed_unzipped_edited/silva_132.18s.99_rep_set.dada2.fa.gz", multithread=TRUE)
...
ps
saveRDS(ps, "ps_18S_Swellan_Feb01_2021.rds")
```
